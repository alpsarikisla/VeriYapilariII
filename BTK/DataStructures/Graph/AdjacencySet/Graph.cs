...
namespace DataStructures.Graph.AdjancencySet
{
    ...
    {
        private Dictionary<T, GraphVertex<T>> vertices; // Sözlük ve düğüm
        public bool isWeightedGraph => false; // Ağırlıklı Çizge mi?
        public int Count => vertices.Count; // Düğüm sayısı?
        public IGraphVertex<T> ReferenceVertex => vertices[this.First()]; // İlk eklenen düğüm referans olacak
        ...
        public bool HasEdge(T source, T dest)
        {
            ...
            {
                throw new ArgumentException("Source and dest vertex is not in this grap");
            }
        ...
        private class GraphVertex<T> : IGraphVertex<T>
        {
            ...
            //{
            //    return $"{Key}"; // BreadFirst keyleri yazdırmak için!
            //}
        }
    }
}
